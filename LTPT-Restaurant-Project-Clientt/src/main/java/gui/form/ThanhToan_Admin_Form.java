 ...
 * @author Thanh Tuan
 */
public class ThanhToan_Admin_Form extends javax.swing.JFrame {
     ...
     */
    public ThanhToan_Admin_Form(String maHD, NhanVien nv, Admin_DashBoard dashBoard) {
    ...
    private void taoHDBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_taoHDBtnActionPerformed
        // TODO add your handling code here:
        hd_dao.updateNhanVienHoaDon(nv.getMaNV(), maHD);
        if(ddb!= null){
        ...
        if(tinhTienThoiKhach() >= 0 && hd_dao.capNhatHoaDon(hd.getMaHD(), maKm , maKh, tinhTongTienThanhToan(), tinhGiamGiaTV(), tinhGiamGiaSinhNhat()) && ban_dao.updateTableState(hd.getBan().getMaBan(), 0)){
            try {
                ...
                Logger.getLogger(ThanhToan_Admin_Form.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
