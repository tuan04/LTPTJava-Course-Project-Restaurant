 ...
 * @author Thanh Tuan
 */
public class CapNhatHoaDon_Admin_PN extends javax.swing.JPanel {
     ...
     */
    public CapNhatHoaDon_Admin_PN(Ban ban, Admin_DashBoard dashBoard) {
        initComponents();
        this.ban = ban;
...
//                System.out.println(cthd.getMonAn().getMaMA() + " " + slmon + " " + slUpdate);
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        try{
            if(cthd_dao.getList(hd.getMaHD())==null){
                ...
                ParameterReportDonTamTinh dataprint = new ParameterReportDonTamTinh(banLabel(), dateFormat(hd.getNgayLap()), nv.getHoTenNV(), currencyFormat(hd.getTongTien()), fields);
    ...
    private void thanhToanBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_thanhToanBtnActionPerformed
        ...
        hd_dao.updateNhanVienHoaDon(nv.getMaNV(), hd.getMaHD());
        if(cthd_dao.getList(hd.getMaHD())!=null){
            new ThanhToan_Admin_Form(hd.getMaHD(), nv, dashBoard).setVisible(true);
        }
        else{
            JOptionPane.showMessageDialog(this, "Hóa đơn chưa có món ăn");
        }
